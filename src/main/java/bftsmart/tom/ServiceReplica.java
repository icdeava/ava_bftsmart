...
//        if (2>1)
    ...
    public void joinMsgReceived(VMMessage msg) {
        ...
        logger.info("msg is "+r.toString());
        logger.info("Join Msg Received,  from node id: {}, r.getView(): {}, id: {}",
                msg.getSender(), r.getView(), id);
...
//                    replier.setReplicaContext(replicaCtx);
    ...
    public void replyReconfig(TOMMessage tm)
    {
        repMan.sendReconfig(tm);
    }
    ...
    public void receiveMessages(int consId[], int regencies[], int leaders[],
        ...
        boolean noop = true;
//        logger.info(" ----> reached inside receiveMessages");
...
//                            SVController.enqueueUpdate(request);
                ...
                } else if (request.getViewID() < SVController.getCurrentViewId() && request.getReqType()!=RECONFIG) {
...
//                        SVController.enqueueUpdate(request);
                ...
                else if (request.getReqType()==RECONFIG){
