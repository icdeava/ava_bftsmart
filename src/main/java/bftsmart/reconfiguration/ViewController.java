...
public class ViewController {
    ...
    protected View currentView0 = null;
    ...
    public ViewController(int procId, String configHome, KeyLoader loader) {
        ...
        this.currentView0 = getViewStore().readView();
    }
...
//             this.currentView0 = this.currentView;
        }
    ...
    public int[] View0Processes() {
        return getCurrentViewId0().getProcesses();
    }

    public View getCurrentViewId0() {
        return this.currentView0;
    }
}